...
class LiveAdvance():
    ...
    def on_new_com_data(self, *args, **kwargs):
        ...
        requests.post('http://localhost:8000/recive',data).json()
...
def main():
    ...
    your_app_client_id = '3R8IXozfwnFbVuiMVTO6KkUGkJsLisk7QTwc13M1'
    your_app_client_secret = 'HRxiDP0fy3lTLnDlPh3mEl69YRARoARea7RryRBicL5DOF9avvZ6BXOkTZo7CGnF9QbzmbkqRwhsrGfG0DMdgz2Sxrm2sa8eBvCv3qiIf4TgZILT8sacQGlcH1EQwJFI'

    # Init live advance
    l = LiveAdvance(your_app_client_id, your_app_client_secret)

    trained_profile_name = '123' # Please set a trained profile name here
